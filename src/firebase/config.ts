...
import { getAuth as getFirebaseAuth, browserPopupRedirectResolver, initializeAuth, indexedDBLocalPersistence, browserLocalPersistence, Auth } from 'firebase/auth';
