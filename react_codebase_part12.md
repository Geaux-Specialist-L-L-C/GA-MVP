...
```json
{
  ...
  "auth": {
    ...
    "additional_redirect_urls": [
      "https://yivklahcdksdpifmapoh.supabase.co"
    ],
    "jwt_expiry": 3600,
...
## /src/hooks/__tests__/useTaskWebSocket.test.ts
...
## /src/components/agent-ui/AgentTaskCreator.tsx
...
## /src/components/agent-ui/RealtimeTaskViewer.tsx
...
## /src/components/agent-ui/learning/CurriculumGenerator.tsx
...
## /src/components/agent-ui/learning/CurriculumViewer.tsx
...
## /src/components/agent-ui/learning/__tests__/CurriculumGenerator.integration.test.tsx
...
## /src/components/agent-ui/learning/__tests__/CurriculumViewer.test.tsx
...
## /src/components/debug/RenderDebugOverlay.tsx
